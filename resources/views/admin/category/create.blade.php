<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.new') }}  {!! trans('blog::category.name') !!} </h3>
    <div class="box-tools pull-right">
        ...
        <button type="button" class="btn btn-default btn-sm" data-action='CLOSE' data-load-to='#blog-category-entry' data-href='{{Trans::to('admin/blog/category/0')}}'><i class="fa fa-times-circle"></i> {{ trans('cms.close') }}</button>
