<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.view') }}   {!! trans('blog::category.name') !!}  [{!! $category->name !!}]  </h3>
    <div class="box-tools pull-right">
        <button type="button" class="btn btn-success btn-sm" data-action='NEW' data-load-to='#blog-category-entry' data-href='{{trans_url('admin/blog/category/create')}}'><i class="fa fa-times-circle"></i> New</button>
        @if($category->id )
