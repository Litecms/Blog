...
@section('heading')
<i class="fa fa-file-text-o"></i> {!! trans('blog::category.name') !!} <small> {!! trans('cms.manage') !!} {!! trans('blog::category.names') !!}</small>
@stop
...
@section('content')
<table id="blog-category-list" class="table table-striped table-bordered data-table">
...
$(document).ready(function(){
    app.load('#blog-category-entry', '{!!URL::to('admin/blog/category/0')!!}');
    ...
    $('#blog-category-list tbody').on( 'click', 'tr', function () {
        ...
        $('#blog-category-entry').load('{!!URL::to('admin/blog/category')!!}' + '/' + d.id);
