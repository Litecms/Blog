...
@section('content')
<table id="blog-blog-list" class="table table-striped table-bordered data-table">
    <thead>
...
$(document).ready(function(){
    ...
    app.load('#blog-blog-entry', '{!!URL::to('admin/blog/blog/0')!!}');
    ...
    $('#blog-blog-list tbody').on( 'click', 'tr', function () {
        ...
        $('#blog-blog-entry').load('{!!URL::to('admin/blog/blog')!!}' + '/' + d.id);
