...
'tag'],
    ...
    'blog'       => [
        'model' => [
            ...
            'appends'               => [],
            'fillable'              => ['id',  'category_id',  'title',  'description',  'images',  'tags',  'viewcount',  'slug',  'meta_title', 'meta_description', 'meta_keyword', 'published',  'published_at',  'user_type',  'user_id',  'upload_folder',  'created_at',  'updated_at',  'deleted_at'],
            'translatables'         => [],
